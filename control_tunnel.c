...
extern int dpa_add_tunnel_if(itf_t *itf, itf_t *phys_itf, PTnlEntry pTunnelEntry);
extern int dpa_update_tunnel_if(itf_t *itf, itf_t *phys_itf, PTnlEntry pTunnelEntry);
